...
### Persistence
Make sure that **SQLite** is installed on your system as it is needed to initialize `miyako_data.db`, where landmine statistics, channel configurations, and active mine counts are stored. 
